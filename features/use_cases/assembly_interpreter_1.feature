Feature: Assembly interpreter - without data hazards
  Description: Input different assembly snippets without errors nor data hazards and check that the program is being interpreted correctly
  ...
  Scenario: Branch and jump
    ...
    And the pipelineOrder is "0,1,2,3,4,12,13,14,15,10,11,12,13,8,9,10,11,14,15,16,17,21,22,23,24,17,18,19,20,21,22,24,25,26,23,24,25,25,26"
