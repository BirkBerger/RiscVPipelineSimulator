...
#    And the result of register "x4" is "-1149"
...
#    And the result of register "x17" is "314236524"
#    And the result of register "x18" is "1169"
#    And the result of register "x20" is "1622"
#    And the result of register "x21" is "473"
#    And the result of register "x22" is "0"
#    And the result of register "x23" is "-1170"
#    And the result of register "x24" is "0"
#    And the result of register "x25" is "1622"
#    And the result of register "x26" is "1622"
#    And the result of register "x27" is "473"
...
#    And the result of register "x6" is "1"
#    And the result of register "x7" is "1"
#    And the result of register "x8" is "27"
#    And the result of register "x9" is "33"
#    And the result of register "x10" is "6"
#    And the result of register "x11" is "34181150"
#    And the result of register "x30" is "9"
#    And the result of register "x31" is "-9"
    And the pipelineOrder is "0,1,2,14,15,16,11,12,13,8,9,10,17,18,19,27,28,29,22,23,24,25,26,32,30,31,33,35"
