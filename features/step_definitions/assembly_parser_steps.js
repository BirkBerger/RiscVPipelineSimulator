...
const ErrorMessageHolder = require('/Users/birkberger/Documents/DTU/Bachelorprojekt/bachelorThesis2/lib/holders/errorMessageHolder');

let errorMessageHolder;

Given("that the assembly editor holds the content of {string}", function (textFileName) {
    let code = fs.readFileSync("features/test_files/assembly_editor/" + textFileName).toString();
