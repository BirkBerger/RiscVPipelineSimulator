...
/**
 * Sets the four pipeline states each including
 * The code array, the highlight list, the register log, and the memory log
 * @param crudeCode - The input assembly string
 * @param instructionSignals - The list of instruction signals
 * @param cleaner - The assembly cleaner object
 * @param initialMemory - The assembled instructions
 */
