        ...
        if (editor.getValue() !== crudeCode) {
            ...
            if (errormessage === "") {
                ...
                try {
                    ...
                    console.log("number of control hazards: " + numberOfControlHazards);
                    ...
                    console.log("number of data hazards: " + numberOfDataHazards);
                    ...
                    console.log("number of data hazards after control solve: " + hazardSolver3.numberOfHazards);
                    console.log("number of all hazards: " + (numberOfControlHazards+numberOfDataHazards));
