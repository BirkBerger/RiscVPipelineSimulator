...
class AssemblyInterpreter {
    ...
    interpretCleanAssemblyCode(cleanCode) {
        ...
        while (this.pc < cleanCode.length) {
            ...
            this.pipelineOrder.push(this.pc);
    ...
    addw_subw(addw) {
        ...
        this.gpRegisters[rsNumbers[0]] = addw ? BigInt.asIntN(64, rs1 + rs2) : BigInt.asIntN(64, rs1 - rs2);
    }
    ...
    multiplyHigh(signedRs1, signedRs2) {
        ...
        this.gpRegisters[fields[0]] = BigInt.asIntN(64, result >>> 64n);
    }
