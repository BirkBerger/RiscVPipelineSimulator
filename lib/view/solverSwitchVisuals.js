...
class SolverSwitchVisuals {
    ...
    solversUnchecked() {
        this.setEnableColor('slider round control');
        this.setEnableColor('slider round data');
    }
    
    controlSolverChecked() {
        this.setEnableColor('slider round data');
        if (numberOfControlHazards !== 0) {
            this.setCheckedColor('slider round control');
        }
    }
    ...
    dataSolverChecked() {
        ...
        if (numberOfDataHazards !== 0) {
            this.setCheckedColor('slider round data');
        }
    }
