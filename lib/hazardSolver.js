...
class HazardSolver {
    ...
    solveControlHazard(labelsByLineNumber) {
        ...
        console.log("highlightingOrder");
        console.log(controlHazardHandler.highlightOrder);
        this.setHighlightingListSingleSolve(controlHazardHandler.highlightOrder);
    }
    ...
    setHighlightingListSingleSolve(highlightingOrder) {
