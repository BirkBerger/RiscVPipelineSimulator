...
class AssemblyStorer {
     ...
     */
    storeCode(code, instructionSignals) {
        var codeArray = code.split("\n");
        // iterate assembly code array
        for (var i = 0; i < codeArray.length; i++) {
            this.cleanAssemblyCode[i] = this.getTrimmedFieldsArray(codeArray[i], i, instructionSignals);
        }
    }
...
window.AssemblyStorer = AssemblyStorer;
// module.exports = AssemblyStorer;