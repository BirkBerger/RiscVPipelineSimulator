 ...
 * Computes the error as a string to be shown in the "code-feedback" textarea.
 */
class AssemblyParser {
    ...
    getInstructionErrors(inst, lineNumber, numberOfLines) {
        ...
        // if the instruction is a label declaration
            ...
            // declare that instruction does not store in rd
            this.doesNotStoreInRD.push(lineNumber);
        }
        else {
            ...
            // if "sc.d" instruction
                ...
                lineErrorMessage += this.ae.regNameError(f2) + ae.regMemAddressError(f3, false);
            }
