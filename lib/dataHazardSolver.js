class DataHazardSolver {
    ...
    instantiateSolveBetweenLines(srcLineNumber, desLineNumber, hazardTypes, srcCC, firstCheck) {
        // console.log("des: " + desLineNumber + " src: " + srcLineNumber);
        // console.log(hazardTypes[0]);
        // console.log(hazardTypes[1]);
        // console.log(firstCheck);
        // console.log(this.detectionBC[0]);
        // console.log(this.detectionBC[1]);
