...
class HazardHandler {
     ...
     */
    detectAndSolveControlHazard(lineNumberByLabel, initialMemory) {
        ...
        controlHazardSolver.solveAll(lineNumberByLabel, initialMemory);
     ...
     * @param registerLog - Register log either empty or from interpreter
