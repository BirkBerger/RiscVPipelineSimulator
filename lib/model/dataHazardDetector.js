...
class DataHazardDetector {
    ...
    /**
     * Check for the 5 data hazard types between a source (instA or instB) and a destination instruction (instC)
     * @param srcInst
     * @param desInst
    ...
    getDetectionBetweenLines(srcInst, desInst) {
        ...
        var rs0Match, rs1Match, rs2Match, storeRdMatch, addressRegMatch;
        ...
        if (srcInst[1] !== "x0") {
                ...
                storeRdMatch = desInst[4][1] && !desInst[4][0] && srcInst[1] === desInst[1];
