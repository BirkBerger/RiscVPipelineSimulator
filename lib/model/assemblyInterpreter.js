...
class AssemblyInterpreter {
    ...
    readMemory(address) {
        ...
        while (typeof this.memLog[ccAvailable] === "undefined" || typeof this.memLog[ccAvailable][address] === "undefined") {
            ccAvailable--;
        }
    ...
    initializeMemory(cc, memAddress, finalAddress) {
        ...
        this.memLog[cc] = [...this.memLog[latestLoggedMemCC]];
    ...
    branch(signed, logicalOperation) {
        ...
        if (condition) {
            ...
            // this.pc = fields[2];
            this.pcChange = [this.cc + 3, fields[2]];
        }
    }
    ...
    jal() {
        ...
        this.pcChange = [this.cc + 3, BigInt(this.lineNumberByLabel[this.inst[2]])];
    }
    ...
    jalr() {
        ...
        this.putFlushesInPipelineOrder();
        // this.pc = newAddress;
        this.pcChange = [this.cc + 3, newAddress];
    }
