class Assembler {
     ...
     * Sets the 10-15 constant bits depending the instruction opcode.
    ...
    /**
     * Converts 12-bit immediate value to its binary equivalent and places in a word.
     * @param immValue - The immediate string
     * @param opcode - The opcode of the instruction holding the immediate
     * @returns {bigint} - The binary immediate extended to a word
     */
    shortImmToBinary(immValue, opcode) {
        ...
        // place in the [32-20] bits of a word
        return binaryImm << 20n;
    }

    /**
     * Converts 20-bit immediate value to its binary equivalent and places in a word.
     * @param immValue - The immediate string
     * @returns {bigint} - The binary immediate extended to a word
     */
    ...
    /**
     * Converts memory address of store instructions to its binary equivalent and places in a word.
     * @param memAddress - Memory address string
     * @returns {bigint} - The 17-bit binary memory address extended to a word
     */
    ...
    /**
     * Converts memory address of load instructions to its binary equivalent and places in a word.
     * @param memAddress - Memory address string
     * @returns {bigint} - The 17-bit binary memory address extended to a word
     */
    ...
    /**
     * Converts branch targets (labels or integers) to its binary equivalent and places in a word.
     * @param target - The target string
     * @param lineNumber - The branch instruction line number
     * @returns {bigint} - The 12-bit binary branch target extended to a word
     */
    ...
    /**
     * Places the lower 5 bits of the branch target in a word.
     * @param binaryAddress - The binary branch target
     * @returns {bigint} - The lower 5 bits extended to a word
     */
    ...
    /**
     * Places the 5-bit binary register on the rd-position of a word.
     * @param regName - The register name
     * @returns {bigint} - The binary register extended to a word
     */
    extendAsRd(regName) {
    ...
    /**
     * Places the 5-bit binary register on the rs1-position of a word.
     * @param regName - The register name
     * @returns {bigint} - The binary register extended to a word
     */
    extendAsRs1(regName) {
    ...
    /**
     * Places the 5-bit binary register on the rs2-position of a word.
     * @param regName - The register name
     * @returns {bigint} - The binary register extended to a word
     */
    extendAsRs2(regName) {
