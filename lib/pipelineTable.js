...
class PipelineTable {
    ...
    constructor() {
        ...
        this.ccColWidth = 40;           // all good
        this.inBetweenCcColWidth = 30;  // all good
        this.headerHeight = 56;
        this.rowHeight = 31;            // should be row height (in 100% its 23) + spacing (set to 8px but probably changes)
        this.halfRowHeight = (this.rowHeight-8.0)/2.0;
    }
    ...
    setHTMLTable(cleanCode) {
        ...
        this.numberOfColumns = Math.max(numberOfFilledColumns,24);
    ...
    insertFlushGraphics(rowNumber, tableFromBase, previousFlush) {
        ...
        for (var j = startCol; j < endCol; j++) {
            if (j % 2 === 0) {
                ...
                tableFromBase.rows[rowNumber].cells[j].innerHTML = '<img width="100%" src="../images/wave_7.png" alt="flush">';
            } else {
    ...
    showHazards(lineNumbersWithHazards) {
