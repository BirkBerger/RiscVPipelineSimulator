...
$(document).ready(function(){
    ...
    $('#pipeline-instructions-button').click(function () {
        $('.register-memory-placeholder').text("Click on a clock cycle in the pipeline to see the RISC-V general purpose registers and data memory contents at the beginning of this time");
    });
});
